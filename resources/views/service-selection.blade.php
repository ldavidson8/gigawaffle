...
@section('stylesheets')
    <style>
        ...
        .selection-wrapper [type=checkbox]:checked + * *
        {
...
<div class="full-size-60 container-fluid" style="padding: 30px 0;">
    <div class="d-flex row col-12">
            <input type="radio" id="all-services" name="filter-services" class="btn-check radio-hidden" checked>
            <label class="filter-button" onclick="filterselection('all')"  for="all-services">All Services<i class="fa fa-folder-open filter-button-icon" aria-hidden="true"></i></label>
            <input type="radio" id="design-dev" name="filter-services" class="btn-check radio-hidden">
            <label class="filter-button" onclick="filterselection('design')" for="design-dev">Design & Dev
                <svg id="Group_78" data-name="Group 78" xmlns="http://www.w3.org/2000/svg" width="auto" height="30" viewBox="0 0 43.671 43.67">
                <g id="paint-palette">
            ...
            <label class="filter-button" onclick="filterselection('marketing')" for="marketing">Marketing
                <svg xmlns="http://www.w3.org/2000/svg" width="auto" height="30" viewBox="0 0 42.248 40.789">
            ...
            <label class="filter-button" onclick="filterselection('media')" for="media">Media
                <svg id="video-player" xmlns="http://www.w3.org/2000/svg" width="auto" height="30" viewBox="0 0 49.724 40.789">
    ...
    <div class="selection-wrapper">
        <div class="filterdiv design">
            ...
            <label for="brand-design" class="selection-button">
        ...
        <div class="filterdiv design">
            <input type="checkbox" id="web-dev" name="web-dev" value="web-dev" class="radio-hidden">
            <label for="web-dev" class="selection-button">
        ...
        <div class="filterdiv design">
        <input type="checkbox" id="ui-design" value="ui-design" class="radio-hidden">
        <label for="ui-design" class="selection-button">
        ...
        <div class="filterdiv design">
        <input type="checkbox" id="graphic-design" value="graphic-design" class="radio-hidden">
        <label for="graphic-design" class="selection-button">
        ...
        <div class="filterdiv design">
        <input type="checkbox" id="packaging-design" value="packaging-design" class="radio-hidden">
        <label for="packaging-design" class="selection-button">
        ...
        <div class="filterdiv design">
        <input type="checkbox" id="staff-systems" value="staff-systems" class="radio-hidden">
        <label for="staff-systems" class="selection-button">
        ...
        <input type="checkbox" id="SEO" value="SEO" class="radio-hidden">
        <label for="SEO" class="selection-button">
        ...
        <div class="filterdiv marketing">
        <input type="checkbox" id="copywriting" value="copywriting" class="radio-hidden">
        <label for="copywriting" class="selection-button">
        ...
        <div class="filterdiv marketing">
        <input type="checkbox" id="digital-marketing" value="digital-marketing" class="radio-hidden">
        <label for="digital-marketing" class="selection-button">
        ...
        <div class="filterdiv marketing">
        <input type="checkbox" id="content-marketing" value="content-marketing" class="radio-hidden">
        <label for="content-marketing" class="selection-button">
        ...
        <div class="filterdiv marketing">
        <input type="checkbox" id="affiliate-marketing" value="affiliate-marketing" class="radio-hidden">
        <label for="affiliate-marketing" class="selection-button">
        ...
        <div class="filterdiv marketing">
        <input type="checkbox" id="email-marketing" value="email-marketing" class="radio-hidden">
        <label for="email-marketing" class="selection-button">
        ...
        <div class="filterdiv media">
        <input type="checkbox" id="video-content" value="video-content" class="radio-hidden">
        <label for="video-content" class="selection-button">
        ...
        <div class="filterdiv media">
        <input type="checkbox" id="audio-content" value="audio-content" class="radio-hidden">
        <label for="audio-content" class="selection-button">
        ...
        <div class="filterdiv media">
        <input type="checkbox" id="social-media" value="social-media" class="radio-hidden">
        <label for="social-media" class="selection-button">
