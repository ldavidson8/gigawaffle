...
@section('main-content')
        <div class="container-lg top-section-outer" style="margin-top: 0;">
            <div class="gradient-container container-no-gradient-sm">
                <h1>Edit an existing Technology</h1>
            ...
            <form method="POST" action="{{ route('control-panel.client-project-technologies.edit') }}" enctype="multipart/form-data">
                @if (count($errors) > 0)
                ...
                <div class="form-group">
                    ...
                    <input class="form-control" type="text" name="name" value="{{ old('name', $technology -> Name) }}" required="required" />
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <input type="number" step="1" class="form-control" name="sort_index" id="sort_index" value="{{ old('sort_index', $technology -> SortIndex) }}" required="required" />
                </div>
