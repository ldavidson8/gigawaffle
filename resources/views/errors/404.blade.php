...
@section('main-content')
        ...
        <div class="col-xl-2 col-lg-2 col-md-2 d-none d-md-block"></div>
            <div class="col-xl-8 col-lg-8 col-md-8 col-sm-12 col-12 "style="background: #f0f0f0;">
                    ...
                    <tr>
                        <td>
                            ...
                            <div style="padding-top:; display: flex; justify-content: center;">
                                <p class="gradient-container gradient-error-pages" style="text-align: center; font-size: 18px; letter-spacing: 1px; height: auto; width: 500px;">This page does not exists</p> 
                            </div>
